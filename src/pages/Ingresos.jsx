    ...
    <div className="page active" style={{ display: 'flex' }}>
      ...
      <div className="card"><div className="card-hdr"><div><div className="card-title">Tendencia de Ingresos</div><div className="card-sub">Últimos 6 meses</div></div><span className="badge bg">↑ Creciendo</span></div>
        <svg width="100%" viewBox="0 0 520 90" preserveAspectRatio="none" style={{"height":"90px"}}>
          ...
          <text x="0" y="87" fontSize="9" fill="rgba(139,156,200,0.6)" fontFamily="sans-serif">Oct</text><text x="95" y="87" fontSize="9" fill="rgba(139,156,200,0.6)" fontFamily="sans-serif">Nov</text><text x="198" y="87" fontSize="9" fill="rgba(139,156,200,0.6)" fontFamily="sans-serif">Dic</text><text x="298" y="87" fontSize="9" fill="rgba(139,156,200,0.6)" fontFamily="sans-serif">Ene</text><text x="398" y="87" fontSize="9" fill="rgba(139,156,200,0.6)" fontFamily="sans-serif">Feb</text><text x="495" y="87" fontSize="9" fill="rgba(139,156,200,0.6)" fontFamily="sans-serif">Mar</text>
        </svg>
      </div>
