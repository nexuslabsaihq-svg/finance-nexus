...
export default function LockScreen({ children }) {
  ...
  // Función para armar los temporizadores de inactividad (sin setState síncrono)
  const resetTimer = useCallback(() => {
    ...
    timeoutRef.current = setTimeout(() => {
      ...
      // Hard Logout después de 30 segundos de bloqueo
      setTimeout(async () => {
        await logout();
      }, 30000);
    }, INACTIVITY_TIMEOUT);
  ...
  // Manejador ante actividad del usuario (oculta advertencia y reprograma timer)
  ...
  useEffect(() => {
    ...
    // Iniciar temporizador al montar sin setState síncrono
    resetTimer();
  ...
  }, [authUser, resetTimer, handleUserActivity]);
